  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 to-black p-6 rounded-2xl border border-gray-800 shadow-xl">
      <div className="flex items-center gap-4">
        ...
        >
          {isPlaying ? (
            <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9" width="36" height="36" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex-1">
          <div className="flex items-center justify-between gap-2">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-2 mt-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-500" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
